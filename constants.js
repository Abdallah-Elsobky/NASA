export const METADATA = {
  ...
  description:
    "Join us on an extraordinary journey where creativity meets cutting-edge technology. Our mission? To leverage data from NASA's archives and solve real-world problems both in space and on Earth.",
  siteUrl: "",
...
export const TYPED_STRINGS = [
  "Innovating for a Sustainable Future in Space!",
"Join us on an extraordinary journey.",
"Where creativity meets technology.",
"Our mission: leverage NASA data.",
"Solve real-world problems in space and on Earth.",
];
